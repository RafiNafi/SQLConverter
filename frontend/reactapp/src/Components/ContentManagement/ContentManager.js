 ...
 */
export function ContentManager({children, metaInformation, diagramType, changeToErDiagram, changeToRelationalDiagram, changeToConverter}){
    ...
    const converterTabActive = diagramType === DiagramTypes.converter ? "TabsButtonActive" : "TabsButtonNotActive";

    let erTabStyle = `TabsButton ${erTabActive}`;
    let relationalTabStyle = `TabsButton ${relationalTabActive}`;
    let converterTabStyle = `TabsButton ${converterTabActive}`;
    ...
    return (
        <React.Fragment>
            ...
            <div className="Head">
                ...
                <button className={converterTabStyle} onClick={changeToConverter}>SQL Converter</button>
                <PrivacyPolicy/>
